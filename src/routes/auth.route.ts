...
import { googleOAuthController, loginUserController, logoutController, refreshTokenController, registerUserController } from "../controllers/auth.controller";
...
router.route('/oauth/google').get(googleOAuthController)
